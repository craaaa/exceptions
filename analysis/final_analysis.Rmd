...
exp1a_scores <- read_csv(here("data", "human", "exp1a.csv"),
  comment = "#",
  col_names = c(
...
exp1b_trigram_scores <- read_csv(here("scores", "exp1b-baselines", "trigram.csv"))
...
exp1b_ambridge_human_scores <- read_csv(here("data", "human", "ambridge.csv")) %>%
  filter(FullSet == "Y")
...
## BLiMP analyses
```{r exp1b_blimp-data}
blimp_results <- list.files(path = here("scores", "exp1b-blimp"), pattern = "*.csv", full.names = TRUE) %>%
